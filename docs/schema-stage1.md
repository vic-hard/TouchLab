...
|---|---|---|---|---|
| `display_profile_id` | string | — | О | `dp-N`; `dp-unset`, если хост ни разу не вызвал `updateDisplayProfile` |
...
| Поле | Тип | Ед. | Обяз. | Примечание |
|---|---|---|---|---|
| `session_id` | string | — | О | задаёт приложение |
...
| Поле | Тип | Ед. | Обяз. | Примечание |
|---|---|---|---|---|
| `trial_id` | string | — | О | задаёт приложение |
